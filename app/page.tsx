    ...
    <main className="overflow-clip" id="main-content">
      ...
      <section className="relative z-10">
        <div className="relative z-10 mx-auto grid min-h-170 w-full max-w-330 grid-cols-[minmax(0,.86fr)_minmax(500px,1.14fr)] items-center gap-[clamp(2.5rem,7vw,7rem)] px-[clamp(1.25rem,4vw,3.5rem)] py-[clamp(4rem,8vw,7rem)] max-[880px]:grid-cols-1 max-sm:min-h-0 max-sm:pt-14">
          ...
          <header className="flex h-12 items-center gap-4 border-b border-[#e7eeee] px-3 text-[.65rem]"><b className="flex items-center gap-1.5"><Image className="size-6 object-contain" src="/docli-isotipo.png" width={24} height={24} alt="" /> Docli</b><span className="ml-auto flex-1 rounded-lg bg-[#f3f7f7] px-2 py-1 text-[#9aabad]">Buscar procesos, tareas…</span><i className="grid size-6 place-items-center rounded-lg bg-primary not-italic text-white">AT</i></header>
